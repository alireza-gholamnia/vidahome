...
- **Agency**: name, slug (انگلیسی خودکار از نام با slugify_from_title), owner (**ForeignKey** User), logo, cities (M2M), intro_content, main_content
- **AgencyImage**: گالری تصاویر مشاوره
- **employees**: reverse از `User.agency` — کاربران با agency پر شده
- **AgencyEmployeeInvite**: دعوت همکاری توسط مالک املاک؛ عضویت فقط بعد از تایید کاربر دعوت‌شده فعال می‌شود
