...
from .models import Agency, AgencyImage
...
class AgencyAdmin(admin.ModelAdmin):
    list_display = ("name", "slug", "owner", "phone", "is_active", "_view_link")
    ...
    fieldsets = (
        ("اطلاعات اصلی", {"fields": ("name", "slug", "owner", "phone", "address", "is_active")}),
