...
urlpatterns = [
    ...
    path("approve/join-request/<int:pk>/", views.approve_join_request, name="approve_join_request"),
    path("approve/remove-request/<int:pk>/", views.approve_remove_request, name="approve_remove_request"),
    path("approve/role-change/<int:pk>/", views.approve_role_change_request, name="approve_role_change_request"),
