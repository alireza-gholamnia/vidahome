...
urlpatterns = [
    ...
    path("services/", views.service_provider_list, name="service_provider_list"),
    path("services/add/", views.service_provider_add, name="service_provider_add"),
    path("services/<int:pk>/edit/", views.service_provider_edit, name="service_provider_edit"),
    ...
    path("approve/service-provider/<int:pk>/", views.approve_service_provider, name="approve_service_provider"),
